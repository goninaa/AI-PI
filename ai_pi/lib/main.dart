...
class MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _loadApiKey() async {
    try {
      // Load OpenAI API key
      String openAiKey = await rootBundle.loadString('assets/api_key.txt');
      // Load ElevenLabs API key
      String elevenLabsKey = await rootBundle.loadString('assets/api_key_voice.txt');
    ...
    String _getYossiPersonality() {
      if (_yossiLevel == 0) {
        ...
        return "You are Yossi Yovel, an Israeli PI, head of the Sagol School for Neuroscience at Tel Aviv University. "
            ...
            "You did your second degree in physics. You bring it up often, even when irrelevant. "
